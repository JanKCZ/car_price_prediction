...
def make_test_prediction(int_features):
	...
	to_predict.loc[0, "condition"] = int_features[3]
	to_predict.loc[0, "service_book"] = int_features[4]
	to_predict.loc[0, "year"] = int_features[5]
	to_predict.loc[0, "fuell"] = int_features[6]
	to_predict.loc[0, "n_doors"] = int_features[7]
	to_predict.loc[0, "air_condition"] = int_features[8]
	to_predict.loc[0, "transmission"] = int_features[9]
